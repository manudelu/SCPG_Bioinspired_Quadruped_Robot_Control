...
Further explanation in the `learning` folder regarding the supervised learning algorithm used and in the `bioloidUnevenTerrain` folder regarding the block diagram of the controller. In addition, there is also a pdf of the paper in Italian [here](Paper (ITA).pdf).
