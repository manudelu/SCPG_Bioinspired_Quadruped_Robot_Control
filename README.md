...
Further explanation inside the `learning` folder, regarding the supervised learning algorithm used, and inside the `bioloidUnevenTerrain` folder, regarding the block diagram of the controller. In addition, there is also a pdf of the paper in Italian [here](https://github.com/manudelu/SCPG_Quadruped_Robot_Control/blob/94144881fbffbc78ccec8cc3d2c6c11f3a335629/Paper%20(ITA).pdf).
